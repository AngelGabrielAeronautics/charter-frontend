          ...
          <Row gutter={16} align="middle" justify="center">
            <Col span={8}>
              <div style={{ textAlign: "center" }}>
                ...
                />
                <Title level={5}>{currentOperator?.airline}</Title>
              </div>
            </Col>
            <Col span={8}>
              <div style={{ textAlign: "center" }}>
                {currentOperator?.status == "Verified" && (
                  <CheckCircleOutlined
                    style={{
                      fontSize: "63px",
                      color: "#52c41a",
                ...
                {currentOperator?.status == "Unverified" && (
                  <CloseCircleOutlined
                    style={{
                      fontSize: "63px",
                      color: "#fa4f50",
        ...
        >
          ...
          >
            <Panel header="Terms and Conditions" key="12">
              <p>
                {currentOperator?.termsAndConditions?.data && (
                  <Link
                    style={{ color: "#0c3747" }}
                    target="_blank"
                    rel="noopener noreferrer"
                    href={`data:application/pdf;base64,${currentOperator.termsAndConditions.data}`}
                    download={
                      currentOperator.termsAndConditions.name ||
            ...
            <Panel header="Cancellation Policy" key="2">
              <p>{currentOperator?.cancellationPolicy}</p>
            </Panel>
            <Panel header="Refund Policy" key="3">
              <p>{currentOperator?.refundPolicy}</p>
            </Panel>
          </Collapse>
        </Card>
      </div>
